...
public class ExplicitStepDefinitions {
    ...
    public void kullanici_delete_webelementini_gorur() {
        ...
        WebElement yeniElement=wait.until(ExpectedConditions.
                visibilityOfElementLocated(By.cssSelector("#elements > button")));
        System.out.println(yeniElement.getText());
        Assert.assertTrue(yeniElement.getText().contains("Delete1"));
    }
